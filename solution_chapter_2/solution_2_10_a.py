...
def main():
    ...
    for dirt_placement, run_label in dirt_placements:
        print(f"{run_label}: ")
        run_vacuum_simulation(grid_size, dirt_probability, dirt_placement, movement_penalty)
        print("-------------")


def run_vacuum_simulation(grid_size, dirt_probability, dirt_placement, movement_penalty, steps=10):
    """
    ...
    vacuum_world = VacuumWorld(grid_size, dirt_probability, movement_penalty)
